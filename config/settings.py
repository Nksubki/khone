"""
تنظیمات پروژه «خونه» — برنامه حسابداری پروژه‌های ساختمانی
"""
import os
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-khone-local-key-please-change-me-in-production",
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "ledger.context_processors.app_context",
            ],
        },
    },
]
...
LOGIN_URL = "/vorod/"
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/vorod/"

SESSION_COOKIE_AGE = 60 * 60 * 24 * 30  # یک ماه
SESSION_SAVE_EVERY_REQUEST = True

MESSAGE_STORAGE = "django.contrib.messages.storage.session.SessionStorage"

# حجم مجاز فایل پیوست (رسید) — ۱۰ مگابایت
